...
LDLIBS_libxendevicemodel = -L$(XEN_LIBXENDEVICEMODEL) -lxendevicemodel
...
LDLIBS_libxenstat  = $(SHDEPS_libxenstat) -L$(XEN_LIBXENSTAT) -lxenstat
...
LDLIBS_libxenvchan = $(SHDEPS_libxenvchan) -L$(XEN_LIBVCHAN) -lxenvchan
...
SHDEPS_libblktapctl =
LDLIBS_libblktapctl = $(SHDEPS_libblktapctl) -L$(XEN_BLKTAP2)/control -lblktapctl
