...
int acpi_build_tables(struct acpi_ctxt *ctxt, struct acpi_config *config)
{
    ...
    else
    {
        ...
        /*
         * The number here is reduced from HVM_MAX_VCPUS to 64 because
         * Windows appears to become more strict in enforcing its CPU limits
         * and 64 VPs is the limit it accepts without ExProcessorMasks being
         * exposed by Xen in our Viridian implementation. CPUs are supposedly
         * calculated based on the number of entries in MADT regardless
         * of entries being enabled or not.
         */
        nr_processor_objects = 64;
    }
