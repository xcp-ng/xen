...
XEN_CPUFEATURE(AMD_MEM_ENCRYPT,   X86_SYNTH(30)) /* AMD Secure Memory Encrypion */
XEN_CPUFEATURE(AMD_SME_COHERENCY, X86_SYNTH(31)) /* AMD Secure Memory Encryption Coherency Enforcement */
