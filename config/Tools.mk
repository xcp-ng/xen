...
XEN_SYSTEMD_SLEEP_DIR := /usr/lib/systemd/system-sleep
CONFIG_9PFS         := 
...
#System options
ZLIB_CFLAGS         :=  -DHAVE_BZLIB -DHAVE_LZMA -DHAVE_LZO1X -DHAVE_ZSTD  -DHAVE_LZ4 
ZLIB_LIBS           :=  -lbz2 -llzma -llzo2 -lzstd  -llz4 
EXTFS_LIBS          := -lext2fs
